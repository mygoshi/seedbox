...
. <(wget -qO- https://code.shutu.me/shutu/seedbox/raw/branch/main/component/seedbox_component.sh)
...
. <(wget -qO- https://code.shutu.me/shutu/seedbox/raw/branch/main/shell/qb-nox-static.sh)
